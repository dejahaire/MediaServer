...
namespace MediaServer
{
    class Server
    {
        ...
        //TODO: Finish Implementation (COMPLETED)
        /// <summary>
        ...
        private void Listen()
        {
            ...
            while (this.running && !pending)
            {
                ...
                //TODO: You probably want to do something here (COMPLETED)

                // Start an asynchronous accept operation
                pending = this.listenSocket.AcceptAsync(e);

                // If AcceptAsync returns false, the operation completed synchronously
                if (!pending)
                {
                    AcceptCallback(this.listenSocket, e);
                }
            }
        }
...
//TODO: Finish implementation. Analyze through the entire method. (COMPLETED)
